...
public class BasicDocument extends Document 
{
	...
	public int getNumSyllables()
	{
		...
		//Take stream of text and separate into a list of words
		List<String> tokens = getTokens("[a-zA-Z]+");
		
		//Initialize the counter for total syllables
		int totalSyllables = 0;
		
		//For each word in the list, count the number of syllables in the word and sum it up
		for (String t : tokens) {
			totalSyllables += countSyllables(t);
		}
		
		//Return the total number of syllables in the stream of text
